...
git clone git@github.com:rktjmp/lush.nvim.git ~/.config/nvim/plugged/lush.nvim
...
git clone git@github.com:skywind3000/vim-terminal-help.git ~/.config/nvim/plugged/vim-terminal-help
